  ...
  return (
    ...
    >
      ...
      <a href={carritoHref} className={`${celda} relative`}>
        ...
        Carrito
        {items > 0 && (
          <span className="absolute right-6 top-1 min-w-4 rounded-full bg-[var(--color-accent-300)] px-1 text-center text-[0.65rem] font-semibold text-[var(--color-neutral-900)]">
            {items}
          </span>
        )}
      </a>
